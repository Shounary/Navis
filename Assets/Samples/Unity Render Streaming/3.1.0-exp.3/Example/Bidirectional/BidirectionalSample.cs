...
#pragma warning disable 0649
        ...
        [SerializeField] private Button toggleMicButton;
...
#pragma warning restore 0649
        ...
        void Awake()
        {
            ...
            toggleMicButton.onClick.AddListener(ToggleMic);
        ...
        {
            microphoneStreamer.enabled = !microphoneStreamer.enabled;
        }

        private void ToggleCamera()
        {
            webCamStreamer.enabled = !webCamStreamer.enabled;
        }
    }
}
